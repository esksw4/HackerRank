class Graph(object):
    ...
    def find_all_distances(self, start):
        visited = [-1 for _ in range(len(self._graph))]
        visited[start] = 0
        _queue = []
        # put in to the queue
        _queue = set(self._graph[start])
           
        # while _queue is not empty
        __level = 1
        while _queue:
            for i in _queue:
                visited[i] = 6 * __level
...
# WRONG:::::::::::::::::::::::::BFS: Shortest Reach in a Graph
...
class Graph(object):
    ...
    def find_all_distances(self, start):
        ...
        while _next_to_visit:
            ...
            _next_to_visit = set([_next_ids for _id in _next_to_visit for _next_ids in self._graph[_id][0] if _next_ids not in visited])
            _level += 1
